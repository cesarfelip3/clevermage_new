...
class Mirasvit_Helpdesk_Adminhtml_FieldController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()
            ->createBlock('helpdesk/adminhtml_field'));
        $this->renderLayout();
    }
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('helpdesk/adminhtml_field_edit'));
        $this->renderLayout();
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('helpdesk/dictionary/field');
    }
