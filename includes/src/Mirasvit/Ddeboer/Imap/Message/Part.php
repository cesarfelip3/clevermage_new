        ...
        if (null === $this->decodedContent) {
            ...
            if ($this->getType() === self::TYPE_TEXT
                ...
                if (extension_loaded('iconv')) {
                    $this->decodedContent = iconv($this->getCharset(),
                        'UTF-8', $this->decodedContent);
                } else {
        ...
        if (isset($structure->parts)) {
            foreach ($structure->parts as $key => $partStructure) {
                ...
                if ((isset($partStructure->disposition)
                    ...
                    $this->parts[] = new Mirasvit_Ddeboer_Imap_Message_Part($this->stream, $this->messageNumber, $partNumber, $partStructure);
                }
            }
        }
    }
