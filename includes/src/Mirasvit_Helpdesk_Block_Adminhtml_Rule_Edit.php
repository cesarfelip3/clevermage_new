...
class Mirasvit_Helpdesk_Block_Adminhtml_Rule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if ($rule = $this->getRule()) {
            return Mage::helper('helpdesk')->__("Edit Rule '%s'", $this->htmlEscape($rule->getName()));
        } else {
            return Mage::helper('helpdesk')->__('Create New Rule');
        }
    }
