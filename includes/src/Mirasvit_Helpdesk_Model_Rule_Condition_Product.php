 ...
 */
class Mirasvit_Helpdesk_Model_Rule_Condition_Product extends Mage_Rule_Model_Condition_Abstract
{
    ...
    protected function _addSpecialAttributes(array &$attributes)
    {
        $attributes = array_merge($attributes, array(
            'attribute_set_id' => Mage::helper('helpdesk')->__('Attribute Set'),
            'category_ids' => Mage::helper('helpdesk')->__('Category'),
            'qty' => Mage::helper('helpdesk')->__('Quantity'),
            'type_id' => Mage::helper('helpdesk')->__('Product Type'),
            'image' => Mage::helper('helpdesk')->__('Base Image'),
            'thumbnail' => Mage::helper('helpdesk')->__('Thumbnail'),
            'small_image' => Mage::helper('helpdesk')->__('Small Image'),
            'image_size' => Mage::helper('helpdesk')->__('Base Image Size (bytes)'),
            'thumbnail_size' => Mage::helper('helpdesk')->__('Thumbnail Size (bytes)'),
            'small_image_size' => Mage::helper('helpdesk')->__('Small Image Size (bytes)'),
            'php' => Mage::helper('helpdesk')->__('PHP Condition'),
        ));
    }

    public function loadAttributeOptions()
    {
        /** @var Mage_Eav_Model_Entity_Abstract $productAttributes */
