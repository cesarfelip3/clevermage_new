...
//          'width'     => '50px',
    ...
    public function _roleFormat(/* @noinspection PhpUnusedParameterInspection */ $renderedValue, $row, $column, $isExport)
    {
        if (!$renderedValue) {
    ...
    public function _departmentsFormat(/* @noinspection PhpUnusedParameterInspection */ $renderedValue, $row, $column, $isExport)
    {
