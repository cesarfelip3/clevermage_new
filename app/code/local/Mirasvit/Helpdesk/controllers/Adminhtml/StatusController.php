...
class Mirasvit_Helpdesk_Adminhtml_StatusController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()
            ->createBlock('helpdesk/adminhtml_status'));
        $this->renderLayout();
    }
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('helpdesk/adminhtml_status_edit'));
        $this->renderLayout();
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('helpdesk/dictionary/status');
    }
