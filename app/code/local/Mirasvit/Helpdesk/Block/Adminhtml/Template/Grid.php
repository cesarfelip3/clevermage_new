...
class Mirasvit_Helpdesk_Block_Adminhtml_Template_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('helpdesk/template')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('name', array(
            'header' => Mage::helper('helpdesk')->__('Internal Title'),
            'index' => 'name',
