...
class Mirasvit_Helpdesk_Block_Adminhtml_Ticket_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _filterSearchCondition(/* @noinspection PhpUnusedParameterInspection */
        $collection, $column)
    {
                ...
                array(
                    ...
                    'actions' => array(
                        array(
                            ...
                            'url' => array(
                                'base' => 'helpdeskadmin/adminhtml_ticket/edit',
                            ),
                            'target'=>  '_blank',
                            'field' => 'id',
                        ),
    ...
    public function _lastActivityFormat(/* @noinspection PhpUnusedParameterInspection */ $renderedValue, $row, $column, $isExport)
    {
    ...
    {
        return $this->getUrl('helpdeskadmin/adminhtml_ticket/edit', array('id' => $row->getId(), 'is_archive' => Mage::registry('is_archive')));
    }
